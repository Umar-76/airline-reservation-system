...
public class AdminHomeDashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        File user = new File("C:\\Users\\Aslam\\IdeaProjects\\AirlineReservationSystem\\images\\icons8_add_user_male_26px_1.png");
    ...
    void flightBtnClicked(ActionEvent event) throws Exception {
        Node [] node = new Node[2];
        node[0] = FXMLLoader.load(getClass().getResource("flight.fxml"));
        mainStage.getChildren().add(node[0]);
    ...
    @FXML
    void userBtnClicked(ActionEvent event) throws Exception {
        Node [] node = new Node[2];
        node[0] = FXMLLoader.load(getClass().getResource("User.fxml"));
        mainStage.getChildren().add(node[0]);
    ...
    void viewBtnClicked(ActionEvent event) throws Exception {
        Node [] node = new Node[2];
        node[0] = FXMLLoader.load(getClass().getResource("viewTicket.fxml"));
        mainStage.getChildren().add(node[0]);
